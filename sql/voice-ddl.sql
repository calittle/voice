...
ALTER TABLE `DISTRICTS` ADD UNIQUE(`DISTRICT`);
...
CREATE TABLE BALLOTS (
    ...
    OPTION_VALUE LONGBLOB NULL DEFAULT NULL,
	...
	PRIMARY KEY (REGISTRANT_ID, ELECTION_ID, MEASURE_ID)
);
...
CREATE TABLE REGISTRANTS (
                ...
                GENDERCD VARCHAR(16) NOT NULL DEFAULT 'UNS',
                ETHNICITYCD CHAR(2) NOT NULL DEFAULT 'UN',
...
ALTER TABLE REGISTRANTS ADD UNIQUE(`USER_ID`);
